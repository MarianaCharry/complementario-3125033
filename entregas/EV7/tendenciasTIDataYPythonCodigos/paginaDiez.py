...
def leer_csv(archivo_csv):
    try:
        ...
        df.columns = ['Cantidad', '2018', '2019', '2020', '2021', '2022','2023','2024']
        
        # Establecer la columna "Sistema Operativo" como índice
        df.set_index('Cantidad', inplace=True)
...
def graficar_datos(df):
    if df is not None:
        ...
        plt.title('Número de desarrolladores de software en todo el mundo entre 2018 y 2024', fontsize=16)
        plt.xlabel('Año', fontsize=12)
        plt.ylabel('Cantidad (millones)', fontsize=12)
...
if __name__ == "__main__":
    archivo_csv = "C:/Users/MOMY/Documents/complementario-3125033/datos/datosExcel/paginaDiez.csv"  # Ruta del archivo CSV
